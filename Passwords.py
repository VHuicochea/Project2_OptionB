...
# TA: Manoj Pravaka
# Last Day Edited: 10/23/2018
# Lab 2 purpose: practice the use of Linked List and Sorting Algorithms

# Class provided by instructor.
# Contains attributes for each Node in the linked list
class Node (object):
    password = ""
    count = -1
    next = None
